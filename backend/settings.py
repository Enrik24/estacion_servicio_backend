...
#SECRET_KE=django-insecure-)_)3l$rks$5=_4ui63np6qn8_^*b1lbba1597tbsi+snqirqu*
...
MIDDLEWARE = [
    ...
    'usuarios.middleware.AdminAccessMiddleware',  # Validar acceso a /admin/
    'seguridad.middleware.BitacoraMiddleware',
]
